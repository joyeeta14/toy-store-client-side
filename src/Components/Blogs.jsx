        ...
        <div className="my-5">
            <div className="flex flex-col w-full border-opacity-50">
                ...
                ">
                    ...
                    <h3 className="ps-7">
                    <span className="font-medium">Ans</span>- Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam quisquam quibusdam suscipit fuga blanditiis perferendis deleniti ipsa quis aspernatur, molestias a natus pariatur animi laborum consequuntur consectetur qui veritatis hic.
                    </h3>
