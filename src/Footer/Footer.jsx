            ...
            <footer className="p-5 bg-base-200 text-black">
                <div className="footer items-center">
                    ...
                    <div>
                      ...
                      <a className="link pe-2 text-lg items-center link-hover">Facebook
                      </a>
                      ...
                      <div className="flex items-center">
                      <a className="link pe-2 text-lg items-center link-hover">Twitter
                      </a>
                      ...
                      <div className="flex items-center">
                      <a className="link pe-2 text-lg items-center link-hover">Youtube
                      </a>
                ...
                <div className="text-center mt-5">
                    <p>Copyright © 2023 - All right reserved by Fun  Store</p>
                </div>
            </footer>
        </div>
    );
